...
Memb4 = Family("Suma", 55,"Thiruvalla") #Created an object Memb4 and passed two argument Name and age
...
Memb1.show_name()# Calling show_name function to show the name of Memb1
Memb2.show_name()# Calling show_name function to show the name of Memb1
Memb3.show_name()# Calling show_name function to show the name of Memb3
Memb4.show_name()# Calling show_name function to show the name of Memb4
...
Memb2.partner.show_name()#Calling show_name function to show the name  of partner Memb1
